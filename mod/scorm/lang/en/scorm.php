...
$string['failonlastattempt'] = 'Fail after final attempt';
$string['failonlastattempt_help'] = 'If enabled, moodle will set the completion status on the course module to failed when the student has used all allocated attempts.';
$string['failonlastattemptdesc'] = 'If enabled, moodle will set the completion status on the course module to failed when the student has used all allocated attempts.';
